...
async def seed_database():
    ...
    async with async_session_maker() as session:
        ...
        configs = [
            ...
            Config(cle="identite_bio", valeur="Je construis des ponts numériques entre l'Afrique et le futur.", description="Bio courte"),
            ...
            Config(cle="seo_description", valeur="Portfolio de Vainqueur Kalema, développeur full stack à Lubumbashi.", description="Meta description"),
        ]
